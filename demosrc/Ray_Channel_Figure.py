...
class RayChannelFigure():
    ...
    def draw_time_data(self):
        ...
        for i in range(len(self.xData[0])):
            real_data.append(self.xData[0][i].real)
            imag_data.append(self.xData[0][i].imag)
        self.panel.Axes.plot(self.yData[0],self.xData[0])
        #self.panel.Axes.plot(self.yData[0],real_data,'g')
        #self.panel.Axes.plot(self.yData[0],imag_data,'r')
