...
class Channel(wx.Panel):
    ...
    def CreateRayBox(self):
        ...
        self.delayIn.SetToolTipString(u"用英文符号','隔开输入")
    ...
    def CreateShiftBox(self):
        ...
        self.shiftIn=wx.TextCtrl(self,-1,"500",size = (103,20), style=wx.TE_PROCESS_ENTER)
        ...
        self.norshiftIn=wx.TextCtrl(self,-1,'0', size = (103,20))
